...
import { loadFacilitiesView, loadFacilityComposerView, loadFacilityDetailView } from '@/router/route-components';
...
export const facilityRoutes: RouteRecordRaw[] = [
  ...
  { path: '/facilities/new', name: 'facility-create', component: loadFacilityComposerView, meta: { navigationDepth: 1, requiresAuth: true } },
